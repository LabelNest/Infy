...
export const BulkEngine: React.FC<Props> = ({ onBulkAdd, isProcessing }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          />
          <div className="absolute bottom-4 right-4 text-[9px] font-black text-slate-400 uppercase tracking-widest">Paste Data Only</div>
        </div>
